...
Form::open(
    array(
    "url" => route('managesitesettings.aircraft.save'),
    "method" => "post",
                ...
                <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                    <div class="col-xl-12 col-xxl-7">
                            ...
                            <div class="d-flex justify-content-between border-top pt-10">
                                ...
                                <div class="mr-2">
                                    {!! Html::link( route('managesitesettings.aircraft.view') , 'Cancel', array('class' => 'btn btn btn-light font-weight-bolder text-uppercase px-9 py-4')) !!}
                                </div>
                                <div>
