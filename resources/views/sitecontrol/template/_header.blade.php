 ...
 <div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header"
     ...
     <div class="container-xxl d-flex align-items-center">
         ...
         <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
             <a href="{{ URL::to('/') }}">
                 <img alt="Logo" src="{{ asset( get_airline_DATA('logo') ) }}" class="logo-default h-25px" />
                 <img alt="Logo" src="{{ asset( get_airline_DATA('logo') ) }}" class="logo-sticky h-25px" />
             </a>
         </div>
             ...
             <div class="d-flex align-items-stretch" id="kt_header_nav">
                 ...
                 <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                     ...
                     <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                         ...
                         <div data-bs-dismiss="click" data-kt-menu-placement="bottom-start"
                             class="parent_nav  menu-item   menu-lg-down-accordion me-lg-1 ">
                             <a class="menu-link py-3" href="{!!  route('dashboard.view') !!}">
                         ...
                         <div data-bs-dismiss="click" data-kt-menu-placement="bottom-start"
                             class="parent_nav  menu-item   menu-lg-down-accordion me-lg-1">
                             <a class="menu-link py-3" href="{!!  route('about-us.view') !!}">
                         ...
                         @if ( RoleManagement::if_Allowed( 'managepilots', 'view' ) || RoleManagement::if_Allowed( 'manageflightshistory', 'view' ) )
                             ...
                             <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px ">
                                ...
                                <div class="menu-item ">
                                    <a class="menu-link py-3"
                                        ...
                                        <span class="menu-title">Pilot List</span>
                                    </a>
                                </div>
                                @endif
                         ...
                         <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             ...
                             <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        href="{!! URL::to( $admin_path . 'events/view') !!}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        ...
                                        <span class="menu-title">Flight Calendar</span>
                                    </a>
                                </div>
                            </div>
                         ...
                         <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             class="parent_nav  menu-item menu-lg-down-accordion me-lg-1">
                             <span class="menu-link py-3">
                                 <span class="menu-title">Pilot Application</span>
                                 <span class="menu-arrow d-lg-none"></span>
                             </span>
                             ...
                             <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        href="{!! URL::to( $admin_path . 'apply-now/view') !!}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        ...
                                        <span class="menu-title">View Requirements</span>
                                    </a>
                                </div>
                            </div>
                         ...
                         <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             ...
                             <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        href="{!! URL::to( $admin_path . 'acars/view') !!}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">ACARS App Download</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        ...
                                        <span class="menu-title">Pilot Resources</span>
                                    </a>
                                </div>
                            </div>
...
<!-- 
                             ...
                             <div
                                 ...
                                 <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                     ...
                                     <div
                                         ...
                                         <div class="menu-item">
                                             <a class="menu-link py-3" href="../../demo2/dist/apps/customers/list.html">
                                                 <span class="menu-bullet">
                                                     <span class="bullet bullet-dot"></span>
                                                 </span>
                                         ...
                                         <div class="menu-item">
                                             <a class="menu-link py-3" href="../../demo2/dist/apps/customers/view.html">
                                                 <span class="menu-bullet">
                                                     <span class="bullet bullet-dot"></span>
                                                 </span>
                                 ...
                                 <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                     ...
                                     <div
                                         class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                         <div class="menu-item">
                                             <a class="menu-link py-3" href="../../demo2/dist/apps/chat/private.html">
                                                 <span class="menu-bullet">
                                                     <span class="bullet bullet-dot"></span>
                                                 </span>
                         ...
                         <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             ...
                             <div
                                 class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                 <div class="menu-item">
                                     <a class="menu-link py-3" href="../../demo2/dist/documentation/base/utilities.html"
                                                 ...
                                                 <div class="symbol symbol-40px me-4">
                                                     <span class="symbol-label bg-light">
                                                         <img class="w-20px h-20px"
                                                             src="{{ asset('assets/media/svg/brand-logos/volicity-9.svg') }}" alt="" />
                                                     </span>
                                                 </div>
                                     ...
                                     <div class="d-flex flex-column px-9">
                                         ...
                                         <div class="text-center px-4">
                                             <img class="mw-100 mh-200px" alt="image"
                                                 src="{{ asset('assets/media/illustrations/sigma-1/1.png') }}" />
                                         </div>
                     ...
                     <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        @if (Auth::guard(  RoleManagement::get_current_user_logged_in_GUARD() )->check() )
                         <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
                             data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                             data-kt-menu-placement="bottom-end">
                             <img class="h-30px w-30px rounded" src="{{ asset(Auth::guard( Config::get('constants.GUARD_DOMAIN_USER') )->user() ->user_image) }}" alt="" />
                         </div>
                         ...
                         <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                             ...
                             <div class="menu-item px-3">
                                 <div class="menu-content d-flex align-items-center px-3">
                                     ...
                                     <div class="symbol symbol-50px me-5">
                                         <img alt="Logo" src="{{ asset(Auth::guard( Config::get('constants.GUARD_DOMAIN_USER') )->user() ->user_image) }}" />
                                     </div>
                                     
                                     
                                     
                                     <div class="d-flex flex-column">
                                         <div class="fw-bolder d-flex align-items-center fs-5">{!! Auth::guard( Config::get('constants.GUARD_DOMAIN_USER') )->user() ->first_name . ' ' . Auth::guard( Config::get('constants.GUARD_DOMAIN_USER') )->user() ->last_name !!}
                                             
                                         </div>
                                         <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{!! Auth::guard( Config::get('constants.GUARD_DOMAIN_USER') )->user() ->email !!}</a>
                                     </div>
                            ...
                            <div class="menu-item px-5">
                                <a href="{!! route('pilot.view.view') !!}" class="menu-link px-5">My Profile</a>
                            </div>
                            ...
                            <div class="separator my-2"></div>
                                ...
                                @if ( RoleManagement::if_Allowed( 'managemyaccount', 'view' ) )
                                    <div class="menu-item px-5 my-1">
                                        <a href="{!! route('managemyaccount.edit') !!}" class="menu-link px-5">Account Settings</a>
                                    </div>
                                @endif

                                @if ( RoleManagement::if_Allowed( 'managesitesettings', 'view' ) )
                                    <div class="menu-item px-5 my-1">
                                        <a href="{!! route('managesitesettings.view') !!}" class="menu-link px-5">Settings</a>
                                    </div>
                                @endif
