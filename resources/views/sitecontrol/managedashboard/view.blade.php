								...
								<div class="col-xxl-8">
									...
									<div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
										<div class="col-xxl-3">
											...
											<div class="card h-150px bgi-no-repeat bgi-size-cover card-xxl-stretch" style="background-image:url({{asset('assets/media/stock/600x400/img-75.jpg')}})">
									...
									<div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
										...
										<div class="col-xxl-6">
											...
											<div class="card h-175px bgi-no-repeat bgi-size-cover card-xxl-stretch mb-5 mb-xl-8" style="background-color: #663259; background-position: calc(100% + 0.5rem) 100%;background-size: 100% auto;background-image:url({{asset('assets/media/svg/misc/taieri.svg')}})">
										...
										<div class="col-xxl-6">
											...
											<div class="card h-100 bgi-no-repeat bgi-size-cover card-xxl-stretch mb-5 mb-xl-8" style="background-image:url({{asset('assets/media/misc/bg-2.jpg')}})">
									...
									<div class="card card-xxl-stretch">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_613229efe9261">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<div>
																<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_613229efe9261" data-allow-clear="true">
																	<option></option>
