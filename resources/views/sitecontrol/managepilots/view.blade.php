            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 datatable " id="kt_table_users">
                ...
                <thead>
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="">Number Flights</th>
                        <th class="">Vatsim ID</th>
                ...
                <tbody class="text-gray-600 fw-bold">
                    ...
                    <tr>
                        ...
                        <!-- <td>{!! $result->airline()->get()->first()->airline_name !!}</td> -->

                        <td class="d-flexx align-items-center">


                            <div class="d-flex flex-column">
                                <a href="{{ route( 'pilot.view.view', ['pilot_id' => $result->id ] )  }}"
                                    class="text-gray-800 text-hover-primary mb-1">{{ $result->first_name . ' ' . $result->last_name }}</a>
                        ...
                        <td>{!! nl2br($result->hub_name ) !!}</td>
                        <td>{!! nl2br($result->rank_name ) !!}</td>

                        <td>
                            <div class="image-input image-input-circle"
                                style="background-image: url({{ asset('assets/media/avatars/blank.png') }})">
                                <div class="image-input-wrapper w-80px h-80px"
                                    style="background-image: url({{asset( $result->user_image ) }})"></div>
                            </div>
                        </td>

                        <td>{!! $result->call_sign !!}</td>

                        <td>{!! $result->number_flights !!}</td>
                        <td>{!! $result->vatsim_id !!}</td>

                        <td>{!! GeneralHelper::format_date( $result->join_date, "d M, Y") !!}</td>
